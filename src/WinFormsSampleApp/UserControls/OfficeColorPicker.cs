...
public partial class OfficeColorPicker : UserControl
{
    ...
    ///// </summary>
    public static readonly int PreferredWidth = 210;
    ///// <summary>
    ///// The preferred height to span the control to
    ///// </summary>
    public static readonly int PreferredHeight = 166;

    // The highlight text color picker is simplified
    public bool IsHighlightColorPicker { get; set; }
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        y += 4;
        if (this.IsHighlightColorPicker)
        {
    ...
    protected void PaintMoreColorsButton(Graphics graphics, int x, int y)
    {
        ...
        Rectangle buttonRec = new Rectangle(x, y, 8 * 26 - 1, 22);
    ...
    /// <param name="x"></param>
    /// <param name="y"></param>
    protected void PaintNoColorButton(Graphics graphics, int x, int y)
    {
        // The rectangle for the 'No Color' button
        Rectangle buttonRec = new Rectangle(x, y, 8 * 26 - 1, 22);
        // The text will be displayed in the center of the rectangle
        // using format string.
        StringFormat format = new StringFormat();
    ...
    private Rectangle PaintColor(Graphics graphics, Color color, bool hotTrack, bool selected, int x, int y)
    {
        ...
        Rectangle mainRec = new Rectangle(x + 3, y + 3, 20, 20);
        // Button border rectangle 
        Rectangle borderRec = new Rectangle(x, y, 26, 26);

        //// Button inside rectangle
        //Rectangle mainRec = new Rectangle(x + 3, y + 3, 11, 11);
        //// Button border rectangle 
        //Rectangle borderRec = new Rectangle(x, y, 17, 17);
        // Check if the button is selected and HotTrack (not the same color)
